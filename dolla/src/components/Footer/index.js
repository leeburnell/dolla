      ...
      <FooterWrap>
        ...
        <SocialMedia>
          <SocialMediaWrap>
            ...
            <WebsiteRights>$LERY © {new Date().getFullYear()} All rights reserved.</WebsiteRights>
            <SocialIcons>
              <SocialIconLink href='/' target='_blank' arial-label='Facebook'>
                <FaFacebook />
              </SocialIconLink>
              <SocialIconLink href='//www.instagram.com/itsBeeroyBTW' target='_blank' arial-label='Instagram'>
                <FaInstagram/>
              </SocialIconLink>
              ...
              <SocialIconLink href='//www.linkedin.com/in/ljburnell' target='_blank' arial-label='Linkedin'>
                <FaLinkedin />
              </SocialIconLink>
            </SocialIcons>
          </SocialMediaWrap>
